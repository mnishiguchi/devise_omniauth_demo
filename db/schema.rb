...
ActiveRecord::Schema.define(version: 20160906145628) do
  ...
  create_table "account_executives", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_account_executives_on_email", unique: true, using: :btree
    t.index ["reset_password_token"], name: "index_account_executives_on_reset_password_token", unique: true, using: :btree
  end
  ...
  create_table "properties", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["client_id"], name: "index_properties_on_client_id", using: :btree
  end
